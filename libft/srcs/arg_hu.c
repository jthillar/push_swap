...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/11 18:45:05 by jthillar          #+#    #+#             */
/*   Updated: 2017/07/20 16:37:03 by jthillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*arg_hu_prev(t_print p, unsigned int n, char *str, char *fill)
{
	int		size;
	char	*tmp;
...
static char	*arg_hu_prev2(t_print p, char *str, char *fill, unsigned int n)
{
	char *tmp;
...
static int	all_zero_hu(t_print p, t_str *list, unsigned int n)
{
