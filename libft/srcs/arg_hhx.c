...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/11 18:16:33 by jthillar          #+#    #+#             */
/*   Updated: 2017/07/20 16:36:54 by jthillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*arg_hhx_prev(t_print p, unsigned int n, char *str, char *fill)
{
	int		size;
	int		diese;
	char	*tmp;
...
static char	*arg_hhx_prev2(t_print p, char *str, char *fill, int n)
{
	char *tmp;
...
static int	all_zero_hhx(t_print p, t_str *list, unsigned int n)
{
...
void		arg_hhx(t_print p, unsigned char n, t_str *list)
{
	...
	(p.weigth_n > ft_strlen(ft_itoabase(n, 16))))
		str = arg_hhx_prev2(p, str, fill, n);
	htag_addlist(p, str, n, list);
}
