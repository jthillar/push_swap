...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/11 18:40:28 by jthillar          #+#    #+#             */
/*   Updated: 2017/07/20 16:36:58 by jthillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*arg_ho_prev(t_print p, unsigned int n, char *str, char *fill)
{
	int		size;
	char	*tmp;
...
static char	*arg_ho_prev2(t_print p, char *str, char *fill, unsigned int n)
{
	char *tmp;
...
static int	all_zero_ho(t_print p, t_str *list, unsigned int n)
{
