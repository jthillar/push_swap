...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/21 17:44:44 by jthillar          #+#    #+#             */
/*   Updated: 2017/07/20 16:43:20 by jthillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*arg_x_prev(t_print p, unsigned int n, char *str, char *fill)
{
	int		size;
	int		diese;
	char	*tmp;
...
static char	*arg_x_prev2(t_print p, char *str, char *fill, int n)
{
	char *tmp;
...
static int	all_zero_x(t_print p, t_str *list, unsigned int n)
{
...
void		arg_x(t_print p, unsigned int n, t_str *list)
{
	char	*str;
	char	*fill;

	fill = NULL;
	if (all_zero_x(p, list, n) == 0)
		return ;
