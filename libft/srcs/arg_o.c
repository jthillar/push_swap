...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/21 18:51:30 by jthillar          #+#    #+#             */
/*   Updated: 2017/07/20 16:39:00 by jthillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*arg_o_prev(t_print p, unsigned int n, char *str, char *fill)
{
	int		size;
	char	*tmp;
...
static char	*arg_o_prev2(t_print p, char *str, char *fill, unsigned int n)
{
	char *tmp;
...
static int	all_zero_o(t_print p, t_str *list, unsigned int n)
{
...
void		arg_o(t_print p, unsigned int n, t_str *list)
{
	char	*str;
	char	*fill;

	fill = NULL;
	if (all_zero_o(p, list, n) == 0)
		return ;
	str = ft_itoabase(n, 8);
